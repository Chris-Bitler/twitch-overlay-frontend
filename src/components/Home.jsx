...
function Home() {
  ...
  return (
    <div className="App">
        ...
        <a href="https://id.twitch.tv/oauth2/authorize?client_id=mqjwij4mecjwx1phznndq706k7o4uh&redirect_uri=https://twitch.voidwhisperer.info&response_type=code&scope=channel:read:subscriptions%20bits:read%20channel:read:redemptions">
